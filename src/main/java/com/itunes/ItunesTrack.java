...
*/
	...
	protected boolean ratingComputed = false;
	protected int albumRating = -1;
	protected boolean albumRatingComputed = false;

	protected int fileType = -1;
	protected int volumeAdjustment = -1;
	protected int startTime = -1;
	
	protected String sortName = null;
	protected String sortAlbum = null;
	protected String sortArtist= null;
	protected String sortAlbumArtist = null;
	protected String sortComposer = null;
