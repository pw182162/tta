...
class TrackProperty
{
	...
	public static final String RATING_COMPUTED = "Rating Computed";
	public static final String ALBUM_RATING = "Album Rating";
	public static final String ALBUM_RATING_COMPUTED = "Album Rating Computed";
	...
	public static final int RATING_COMPUTED_HASH_CODE = RATING_COMPUTED.hashCode();
	public static final int ALBUM_RATING_HASH_CODE = ALBUM_RATING.hashCode();
	public static final int ALBUM_RATING_COMPUTED_HASH_CODE = ALBUM_RATING_COMPUTED.hashCode();
	public static final int FILE_TYPE_HASH_CODE = FILE_TYPE.hashCode();
	public static final int VOLUME_ADJUSTMENT_HASH_CODE = VOLUME_ADJUSTMENT.hashCode();
	public static final int START_TIME_HASH_CODE = START_TIME.hashCode();
	public static final int SORT_NAME_HASH_CODE = SORT_NAME.hashCode();
	public static final int SORT_ALBUM_HASH_CODE = SORT_ALBUM.hashCode();
	public static final int SORT_ARTIST_HASH_CODE = SORT_ARTIST.hashCode();
	public static final int SORT_ALBUM_ARTIST_HASH_CODE = SORT_ALBUM_ARTIST.hashCode();
	public static final int SORT_COMPOSER_HASH_CODE = SORT_COMPOSER.hashCode();
	public static final int RELEASE_DATE_HASH_CODE = RELEASE_DATE.hashCode();
	public static final int PURCHASED_HASH_CODE = PURCHASED.hashCode();
	public static final int HAS_VIDEO_HASH_CODE = HAS_VIDEO.hashCode();
}
